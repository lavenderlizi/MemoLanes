...
/// An adaptive translucent surface for controls displayed over rich content.
///
/// Its light and dark treatments preserve the content behind it while keeping
/// controls readable. It is independent from the map's unexplored-area mask.
class LiquidGlassSurface extends StatelessWidget {
  const LiquidGlassSurface({
    ...
    this.shadowAlpha,
    this.shadowBlurRadius = StyleConstants.overlayShadowBlurRadius,
    this.shadowSpreadRadius = StyleConstants.overlayShadowSpreadRadius,
    this.shadowOffset = StyleConstants.overlayShadowOffset,
    this.padding,
  ...
  Widget build(BuildContext context) {
    ...
    final effectiveShadowAlpha =
        shadowAlpha ?? StyleConstants.overlayShadowAlpha;
