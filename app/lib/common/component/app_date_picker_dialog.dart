...
class _AppDatePickerDialogState extends State<_AppDatePickerDialog> {
  ...
  void _setCalendarViewMode(CalendarDatePicker2Mode mode) {
    setState(() {
      // The package returns to day mode internally after a month is selected,
      // but does not notify when the already displayed month is reselected.
      if (_calendarViewMode == mode) _calendarPickerRevision += 1;
            ...
            SizedBox(
              ...
              child: CalendarDatePicker2(
                ...
                onDisplayedMonthChanged: (displayedMonth) {
                  // The package has already returned to day mode. Keep the
                  // next config rebuild in sync without resetting the month.
                  _displayedMonthDate = DateTime(
                    displayedMonth.year,
